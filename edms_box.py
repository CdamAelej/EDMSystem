...
class Ui_ECDS_form(object):
    def setupUi(self, ECDS_form):
        ...
        self.pokazDaneLogowania_tableWidget.setGeometry(QtCore.QRect(10, 10, 421, 261))
        self.pokazDaneLogowania_tableWidget.setRowCount(2)
        self.pokazDaneLogowania_tableWidget.setColumnCount(4)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.pokazDaneLogowania_tableWidget.setHorizontalHeaderItem(3, item)
    ...
    def retranslateUi(self, ECDS_form):
        ...
        item.setText(_translate("ECDS_form", "ID"))
        ...
        item = self.pokazDaneLogowania_tableWidget.horizontalHeaderItem(3)
